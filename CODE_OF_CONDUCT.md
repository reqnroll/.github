# Reqnroll Community Code of Conduct

*This document has been adapted from the [Cucumber Community Code of Conduct](https://github.com/cucumber/.github/blob/main/CODE_OF_CONDUCT.md)*

Reqnroll is used and developed by people from all over the world who have a diverse set of skills, personalities and experiences. This diversity is wonderful, and we are committed to ensuring that the Reqnroll community is a safe, enjoyable and thriving environment for everyone.
...
- On GitHub, Discord and other online or offline communications channels, don't use sexual/racially offensive nicknames or avatars, or other nicknames/avatars that might detract from a friendly, safe and welcoming environment for all.
...
- Sponsors of Reqnroll events are also subject to this Code of Conduct. In particular, sponsors are required to not use sexualized images, activities, or other material which is in violation of this Code of Conduct.

## Who do these rules apply to?

These rules apply to anyone involved in the Reqnroll community, including but not limited to organisers and attendees at Reqnroll events, maintainers and contributors of open source projects, and community members engaged in discussions on issue trackers, mailing lists or chat rooms.

## Where does this apply?

The rules listed above apply to all official Reqnroll venues; including in-person events like conferences or trainings, the official Discord chat server; GitHub repositories under the `reqnroll` org, and any other officially-sanctioned community channels.
...
The current moderators of the Reqnroll community are:

- Gaspar Nagy
- Andrii Kurdiumov

You can contact us by email at <mods@reqnroll.net>.

## References / inspiration

We’re grateful to these references for providing us with ideas and inspiration for this document:

- https://github.com/cucumber/.github/blob/main/CODE_OF_CONDUCT.md
